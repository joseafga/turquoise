  ...
  class Eloquent
    ...
    module Chat
      ...
      struct Request
        ...
        # Developer set `system instruction(s)`. Currently, text only. _(Optional)_
        #
        ...
        # The content of the current conversation with the model. _(Required)_
        # For single-turn queries, this is a single instance. For multi-turn queries  like chat, this is a repeated
        # field that contains the conversation history and the latest request.
        property contents : Deque(Chat::Content)

        # A list of Tools the Model may use to generate the next response. _(Optional)_
        property tools : Array(Tool)?

        # Tool configuration for any Tool specified in the request. Refer to the Function calling guide for a usage
        # example. _(Optional)_
        @[JSON::Field(key: "toolConfig")]
        property tool_config : ToolConfig?

        # A list of unique SafetySetting instances for blocking unsafe content. _(Optional)_
        @[JSON::Field(key: "safetySettings")]
        property safety_settings : Array(SafetySetting)?

        # Configuration options for model generation and outputs. _(Optional)_
        ...
        struct GenerationConfig
          ...
          # varied and creative, while a value closer to `0.0` will typically result in more straightforward responses
          # from the model.
          ...
          # A positive penalty will discourage the use of tokens that have already been used in the response, increasing
          # the vocabulary.
          ...
          # of times the token has been used: The more a token is used, the more dificult it is for the model to use
      ...
      struct Result
        ...
        # Metadata on the generation requests' token usage. _(Output only)_
        ...
        struct Candidate
          include JSON::Serializable
          # Generated content returned from the model. _(Output only)_
          # This is not optional but some finish reasons respond without a content field.
          getter content : Chat::Content?

          # The reason why the model stopped generating tokens. _(Optional, Output only)_
          ...
          # Citation information for model-generated candidate. _(Output only)_
          # This field may be populated with recitation information for any text included in the content. These are
          # passages that are "recited" from copyrighted material in the foundational LLM's training data.
          # TODO: citationMetadata - object (CitationMetadata)

          # Token count for this candidate. _(Output only)_
          ...
          # Log-likelihood scores for the response tokens and top tokens _(Output only)_
          # TODO: logprobsResult - object (LogprobsResult)

          # Index of the candidate in the list of response candidates. _(Output only)_
        ...
        struct PromptFeedback
          include JSON::Serializable
          # If set, the prompt was blocked and no candidates are returned. _(Optional)_
      ...
      struct Tool
        include JSON::Serializable
        # A list of `FunctionDeclarations` available to the model that can be used for function calling. _(Optional)_
        @[JSON::Field(key: "functionDeclarations")]
        property function_declarations : Array(FunctionDeclaration)?

        # Enables the model to execute code as part of generation. _(Optional)_
      ...
      struct FunctionDeclaration
        include JSON::Serializable
        # The name of the function. _(Required)_
        property name : String
        # A brief description of the function. _(Required)_
        property description : String
        # Describes the parameters to this function. _(Optional)_
      ...
      struct FunctionCall
        include JSON::Serializable
        # The name of the function to call. _(Required)_
        getter name : String
        # The function parameters and values in JSON object format. _(Optional)_
      ...
      struct FunctionResponse
        ...
        # The name of the function to call. _(Required)_
        property name : String
        # The function response in JSON object format. _(Required)_
      ...
      struct ToolConfig
        include JSON::Serializable
        # Function calling config. _(Optional)_
      ...
      struct FunctionCallingConfig
        include JSON::Serializable
        # Specifies the mode in which function calling should execute. _(Optional)_
        property mode : Mode?

        # A set of function names that, when provided, limits the functions the model will call. _(Optional)_
      ...
      # * __functionCall__: object (FunctionCall) - A predicted FunctionCall returned from the model that contains a
      #   string representing the `FunctionDeclaration#name` with the arguments and their values.
      # * __functionResponse__: object (FunctionResponse) - The result output of a `FunctionCall` that contains a string
      #   representing the `FunctionDeclaration#name` and a structured JSON object containing any output from the
      #   function is used as context to the model.
      # * __fileData__: object (FileData) - URI based data.
      # * __executableCode__: object (ExecutableCode) - Code generated by the model that is meant to be executed.
      # * __codeExecutionResult__: object (CodeExecutionResult) - Result of executing the ExecutableCode.
      #
      ...
      struct Content
        include JSON::Serializable
        # The producer of the content. _(Optional)_
        property role : Role?
